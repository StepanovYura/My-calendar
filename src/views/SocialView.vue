  ...
  <main class="container">
    <div class="views">
      <div class="choice-friend">
        <button type="button" id="comm-event-choice" class="comm-btn">
          <img src="" alt="событие">
        </button>
        <button type="button" id="comm-group-choice" class="comm-btn">
          <img src="" alt="группа">
        </button>
        <button type="button" id="comm-friends-choice" class="comm-btn">
          <img src="" alt="друзья">
        </button>
      </div>
      <div class="calendary">
