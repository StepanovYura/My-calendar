...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://myappuser:MyAppUserStrongPassword@YuraSt-4632.postgres.pythonanywhere-services.com:14632/myappdb?options=-c search_path=public'  # os.getenv('DATABASE_URL', 'postgresql://postgres:password@localhost:5432/schedule_db').replace('postgres://', 'postgresql://')#'postgresql://postgres:Namigra_20@localhost:5432/schedule_db?options=-c search_path=schedule_app,public'
